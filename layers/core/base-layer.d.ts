 ...
 * 共通の機能と振る舞いを定義します
 */
export declare abstract class BaseLayer<TAttr extends LayerAttr = LayerAttr, TStyle extends LayerStyle = LayerStyle> implements ILayer {
    /** レイヤーの一意識別子 */
    readonly id: string;
    /** レイヤーの表示状態 */
    visible: boolean;
     ...
     */
    constructor(id: string, attr?: TAttr, style?: TStyle);
    /**
     * レイヤーを描画します（サブクラスで実装）
    ...
    private static readonly CAMEL_CASE_SVG_ATTRS;
    /**
