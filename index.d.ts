...
export type { ThematikaOptions, LayerAttr, LayerStyle, ILayer, ILineConnectionLayer, ILineTaperedLayer, ArcControlPointType, ArcOffsetType, TileCoordinate, TileBounds, TileUrlInfo, TileGenerationOptions } from './types';
...
export type { NorthArrowLayerOptions } from './layers/utils/north-arrow-layer';
...
export { NorthArrowLayer } from './layers/utils/north-arrow-layer';
